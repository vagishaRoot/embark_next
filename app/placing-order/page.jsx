...
import { cart, cookiesState, navigateState, placedOrders } from '../state/appAtom';
...
const steps = [
  ...
  useEffect(()=>{
    if(Object.keys(cookies).length == 0 && cartDetails?.length == 0 && jumpToLogin){
      router.push("/login")
    ...
    <div className="flex justify-center">
        <div className="w-[80%] flex flex-col gap-y-[30px] max-1800:w-[90%] 1024-768:w-[96%]">
            ...
            >
                ...
                {current === 0 ? <Button type="" onClick={logout}>Jump to login page</Button> : <></>}
